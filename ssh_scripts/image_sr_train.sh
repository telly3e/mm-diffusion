...
TRAIN_FLAGS="--lr 1e-4 --batch_size 6 --devices G8 --log_interval 100 --sample_fn ddpm 
 ...
 --use_db False --resume_checkpoint ./models/guided-diffusion_64_256_upsampler.pt" #--schedule_sampler loss-second-moment --resume_checkpoint models/256x256_diffusion_uncond.pt

NUM_GPUS=8
DATA_DIR="./data/landscape_png/train"
OUT_DIR="./output/sr-image-train/"
